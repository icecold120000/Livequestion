...
<div class="grey">
	...
	<div class="background-grey1">
		<img src="Contents/search.png"/>
		<input type="text" name="recherche-site" aria-label="rechercher informations" placeholder="Rechercher une question"/>
	...
	<div class="background-grey">
		...
		<p>A votre avis, quelle cravate me va le mieux pour mon entretien d'embauche de demain</p>
		<div>
	...
	<div class="background-grey">
		...
		<p>Est-ce que cette décoration pour notre nouvelle chambre d'hôte vous plaît ?</p>
		<div>
